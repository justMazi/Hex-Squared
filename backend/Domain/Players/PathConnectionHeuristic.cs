...
public class PathFinderHeuristic(int playerNum) : AiPlayer(playerNum)
{
    ...
    private List<Hex>? FindShortestPath(IEnumerable<Hex> hexagons, IEnumerable<Hex> startingEdge, IEnumerable<Hex> targetEdge, int playerNum)
    {
    ...
    private IEnumerable<Hex> GetStartingEdge(IEnumerable<Hex> hexagons, int playerNum, int radius)
    {
    ...
    private IEnumerable<Hex> GetTargetEdge(IEnumerable<Hex> hexagons, int playerNum, int radius)
    {
        return hexagons.Where(h => playerNum switch
        {
    ...
    private int HexDistanceToCenter(Hex hex)
    {
    ...
    private int HexDistanceToTargetEdge(Hex hex, IEnumerable<Hex> targetEdge)
    {
        return targetEdge
